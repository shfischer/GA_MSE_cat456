...
### ------------------------------------------------------------------------ ###
  ...
  if (identical(MP, "CC_f")) {
    ...
    ga_suggestions <- rbind(### default
                            c(2, 0.2, 0.1, 0.2, 0.1, 0.05, 0.01, 0.1, 1, 1, 1, 0), 
                            ### zero catch
                            c(2, 0.2, 0.1, 0.2, 0.1, 0.05, 0.01, 0.1, 1, 0, 1, 0), 
                            ### interval
                            c(1, 0.2, 0.1, 0.2, 0.1, 0.05, 0.01, 0.1, 1, 1, 1, 0), 
                            c(3, 0.2, 0.1, 0.2, 0.1, 0.05, 0.01, 0.1, 1, 1, 1, 0), 
                            c(4, 0.2, 0.1, 0.2, 0.1, 0.05, 0.01, 0.1, 1, 1, 1, 0), 
                            c(5, 0.2, 0.1, 0.2, 0.1, 0.05, 0.01, 0.1, 1, 1, 1, 0), 
                            ### lambda/gamma
                            c(2, 0.1, 0.1, 0.2, 0.1, 0.05, 0.01, 0.1, 1, 1, 1, 0), 
                            c(2, 0.3, 0.1, 0.2, 0.1, 0.05, 0.01, 0.1, 1, 1, 1, 0), 
                            c(2, 0.2, 0.05, 0.2, 0.1, 0.05, 0.01, 0.1, 1, 1, 1, 0), 
                            c(2, 0.2, 0.2, 0.2, 0.1, 0.05, 0.01, 0.1, 1, 1, 1, 0), 
                            c(2, 0.2, 0.1, 0.1, 0.1, 0.05, 0.01, 0.1, 1, 1, 1, 0), 
                            c(2, 0.2, 0.1, 0.3, 0.1, 0.05, 0.01, 0.1, 1, 1, 1, 0), 
                            c(2, 0.2, 0.1, 0.2, 0.05, 0.05, 0.01, 0.1, 1, 1, 1, 0), 
                            c(2, 0.2, 0.1, 0.2, 0.3, 0.05, 0.01, 0.1, 1, 1, 1, 0), 
                            ### thresholds
                            c(2, 0.2, 0.1, 0.2, 0.1, 0.01, 0.01, 0.1, 1, 1, 1, 0), 
                            c(2, 0.2, 0.1, 0.2, 0.1, 0.02, 0.01, 0.1, 1, 1, 1, 0), 
                            c(2, 0.2, 0.1, 0.2, 0.1, 0.05, 0.01, 0.1, 1, 1, 1, 0), 
                            c(2, 0.2, 0.1, 0.2, 0.1, 0.10, 0.01, 0.1, 1, 1, 1, 0), 
                            c(2, 0.2, 0.1, 0.2, 0.1, 0.05, 0.01, 0.1, 1, 1, 1, 0), 
                            c(2, 0.2, 0.1, 0.2, 0.1, 0.05, 0.02, 0.1, 1, 1, 1, 0), 
                            c(2, 0.2, 0.1, 0.2, 0.1, 0.05, 0.05, 0.05, 1, 1, 1, 0), 
                            c(2, 0.2, 0.1, 0.2, 0.1, 0.05, 0.10, 0.2, 1, 1, 1, 0), 
                            c(2, 0.2, 0.1, 0.2, 0.1, 0.05, 0.01, 0.0, 1, 1, 1, 0), 
                            c(2, 0.2, 0.1, 0.2, 0.1, 0.05, 0.01, 0.2, 1, 1, 1, 0), 
                            ### multipliers
                            c(2, 0.2, 0.1, 0.2, 0.1, 0.05, 0.01, 0.1, 0.8, 1, 1, 0), 
                            c(2, 0.2, 0.1, 0.2, 0.1, 0.05, 0.01, 0.1, 0.9, 1, 1, 0), 
                            c(2, 0.2, 0.1, 0.2, 0.1, 0.05, 0.01, 0.1, 1.1, 1, 1, 0), 
                            c(2, 0.2, 0.1, 0.2, 0.1, 0.05, 0.01, 0.1, 1.2, 1, 1, 0), 
                            c(2, 0.2, 0.1, 0.2, 0.1, 0.05, 0.01, 0.1, 1, 0.8, 1, 0), 
                            c(2, 0.2, 0.1, 0.2, 0.1, 0.05, 0.01, 0.1, 1, 0.9, 1, 0), 
                            c(2, 0.2, 0.1, 0.2, 0.1, 0.05, 0.01, 0.1, 1, 1.1, 1, 0), 
                            c(2, 0.2, 0.1, 0.2, 0.1, 0.05, 0.01, 0.1, 1, 1.2, 1, 0),
                            ### catch limits
                            c(2, 0.2, 0.1, 0.2, 0.1, 0.05, 0.01, 0.1, 1, 1, 0.5, 0), 
                            c(2, 0.2, 0.1, 0.2, 0.1, 0.05, 0.01, 0.1, 1, 1, 0.4, 0), 
                            c(2, 0.2, 0.1, 0.2, 0.1, 0.05, 0.01, 0.1, 1, 1, 1.0, 1.0), 
                            c(2, 0.2, 0.1, 0.2, 0.1, 0.05, 0.01, 0.1, 1, 1, 1.0, 0.8), 
                            c(2, 0.2, 0.1, 0.2, 0.1, 0.05, 0.01, 0.1, 1, 1, 1.0, 0.5) 
                            )
  }
